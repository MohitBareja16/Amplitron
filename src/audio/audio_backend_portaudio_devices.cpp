...
bool AudioEngine::set_input_device(int device_index) {
    ...
    if (out_info && info->hostApi != out_info->hostApi) {
        ...
        const PaHostApiInfo* out_api = g_mock_pa_get_host_api_info ? g_mock_pa_get_host_api_info(out_info->hostApi) : Pa_GetHostApiInfo(out_info->hostApi);
...
bool AudioEngine::set_output_device(int device_index) {
    ...
    if (in_info && in_info->hostApi != info->hostApi) {
        const PaHostApiInfo* in_api = g_mock_pa_get_host_api_info ? g_mock_pa_get_host_api_info(in_info->hostApi) : Pa_GetHostApiInfo(in_info->hostApi);
